...
# حط التوكن بتاع البوت هنا أو في متغيرات البيئة
TOKEN = os.getenv("TOKEN") or "8441832522:AAF7JRh0aw1X2diiCFdg8Fx9cGU2L-1NXuY"

# URL و HEADERS كما في النسخة الأصلية
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    if context.user_data.get("in_progress"):
        await update.message.reply_text("⚠️ هناك عملية جارية بالفعل. انتظر انتهاءها قبل البدء مرة أخرى.")
...
def main():
    ...
    APP_URL = os.getenv("APP_URL")  # رابط التطبيق على Railway
