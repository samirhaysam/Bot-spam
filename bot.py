...
2. أرسل الباسورد بتاع ماي أورانج بتاعك
...
async def get_password(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text("تمام، دلوقتي ادخل رقم السيريال (اتصل #119# للحصول عليه واتأكد من ازالة حرف F من الكود قبل الارسال):")
    return SERIAL
